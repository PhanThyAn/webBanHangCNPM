...
<%--<%--%>
<%--&lt;%&ndash;    List<ProductSearchModel> listPro = (List<ProductSearchModel>)request.getAttribute("listPro");&ndash;%&gt;--%>
<%--&lt;%&ndash;    DecimalFormat formatter = new DecimalFormat("###,###,###");&ndash;%&gt;--%>
<%--&lt;%&ndash;    int pageNum = (int) request.getAttribute("page");&ndash;%&gt;--%>
<%--&lt;%&ndash;    int totalPage = (int) request.getAttribute("totalPage");&ndash;%&gt;--%>
<%--&lt;%&ndash;    String display = (String)request.getAttribute("display");&ndash;%&gt;--%>
<%--&lt;%&ndash;    String orderBy = (String)request.getAttribute("orderBy");&ndash;%&gt;--%>
<%--&lt;%&ndash;    String sortBy = (String)request.getAttribute("sortBy");&ndash;%&gt;--%>
<%--%>--%>
<%
%>
<!DOCTYPE html>
                    ...
                    <c:if test="${listPro != null}">
                        <div class="container">
                            <div class="content">
                                                ...
                                                <div class="col col-xs-12 ">
                                                    <c:if test="${display == 'grid'}">
                                                        ...
                                                        <ul class="nav nav-tabs">
                                                            <li>
                                                                <a href="search?search=${textSearch}&page${page}%>&display=grid&orderBy=${orderBy}&sortBy=${sortBy}"
                                                                   class="fa fa-th-large active show"></a>
                                                            </li>
                                                            <li>
                                                                <a href="search?search=${textSearch}&page=${page}%>&display=list&orderBy=${orderBy}&sortBy=${sortBy}"
                                                        ...
                                                        <ul class="nav nav-tabs">
                                                            <li>
                                                                <a href="search?search=${textSearch}&page=${page}&display=grid&orderBy=${orderBy}&sortBy=${sortBy}"
                                                                   ...
                                                                   data-ca-target-class="tab-content"
                                                            ...
                                                            <li>
                                                                <a href="search?search=${textSearch}&page=${page}&display=list&orderBy=${orderBy}&sortBy=${sortBy}"
                                                                   data-toggle="tab-content"
                                                                   data-ca-target-class="tab-content"
                                                                   class="fa fa-list-ul active show"></a>
                                                            </li>
                                                        </ul>
                                                    </c:if>
                                                ...
                                                <div class="col col-xs-12">
                                                    <div class="d-flex sort-by-row justify-content-end">
                                                        <div class="products-sort-order dropdown">
                                                            <c:if test="${orderBy == 'name' && sortBy == 'asc'}">
                                                                <button class="btn btn-primary dropdown-toggle"
                                                                        data-toggle="dropdown" aria-expanded="false">
                                                                    Theo ký tự, A to Z
                                                                </button>
                                                            </c:if>
                                                            <c:if test="${orderBy == 'name' && sortBy == 'desc'}">
                                                                <button class="btn btn-primary dropdown-toggle"
                                                                        data-toggle="dropdown" aria-expanded="false">
                                                                    Theo ký tự, Z to A
                                                                </button>
                                                            </c:if>
                                                            <c:if test="${orderBy == 'price_sell' && sortBy == 'asc'}">
                                                                <button class="btn btn-primary dropdown-toggle"
                                                                        data-toggle="dropdown" aria-expanded="false">
                                                                    Theo giá , từ thấp tới cao
                                                                </button>
                                                            </c:if>
                                                            <c:if test="${orderBy == 'price_sell' && sortBy == 'desc'}">
                                                                <button class="btn btn-primary dropdown-toggle"
                                                                        data-toggle="dropdown" aria-expanded="false">
                                                                    Theo giá , từ cao tới thấp
                                                                </button>
                                                            </c:if>
                                                            <c:if test="${orderBy == 'onsale'}">
                                                                <button class="btn btn-primary dropdown-toggle"
                                                                        data-toggle="dropdown" aria-expanded="false">
                                                                    Có giảm giá
                                                                </button>
                                                            ...
                                                            <ul class="dropdown-menu"
                                                                style="width: 200px;height: 230px;top:36px;border-radius: 4px">
                                                                <li><a class="dropdown-item"
                                                                       href="search?search=${textSearch}&page=${pageNum}&display=${display}">Mặc
                                                                    định</a></li>
                                                                    <%--<li><a class="dropdown-item" href="living-room?page=<%=pageNum%>&display=<%=display%>&orderBy=">Sản phẩm mới</a></li>--%>
                                                                <li><a class="dropdown-item"
                                                                       href="search?search=${textSearch}&page=${pageNum}&display=${display}&orderBy=name&sortBy=asc">Theo
                                                                    ký tự, A to Z</a></li>
                                                                <li><a class="dropdown-item"
                                                                       href="search?search=${textSearch}&page=${pageNum}&display=${display}&orderBy=name&sortBy=desc">
                                                                    Theo ký tự, Z to A</a></li>
                                                                <li><a class="dropdown-item"
                                                                       href="search?search=${textSearch}&page=${pageNum}&display=${display}&orderBy=price_sell&sortBy=asc">Theo
                                                                    giá , từ thấp tới cao</a></li>
                                                                <li><a class="dropdown-item"
                                                                       href="search?search=${textSearch}&page=${pageNum}&display=${display}&orderBy=price_sell&sortBy=desc">
                                                                    Theo giá , từ cao tới thấp</a></li>
                                                                    <%--<li><a class="dropdown-item" href="javascript:;">Sản phẩm bán chạy</a></li>--%>
                                                                <li><a class="dropdown-item"
                                                                       href="search?search=${textSearch}&page=${pageNum}&display=${display}&orderBy=onsale">Có
                                                                    giảm giá</a></li>
                                                            </ul>
                                                                ...
                                                                <div class="product-miniature js-product-miniature item-one first-item">
                                                                    <div class="thumbnail-container border">
                                                                        <a href="product_detail?pid=${pro.getId()}">
                                                                            <img class="img-fluid image-cover"
                                                                                 src="${pro.getListImg().get(0).getUrl()}"
                                                                                 alt="img">
                                                                    ...
                                                                    <div class="product-description">
                                                                        <div class="product-groups">
                                                                            ...
                                                                            <c:choose>
                                                                                <c:when test="${pro.price_sell < pro.price}">
                                                                                    <div class="product-price-and-shipping">
                                                                                    <span class="price"
                                                                                          style="font-size: 12px; text-decoration: line-through; color: #939393; padding-bottom: 8px;">
                                                                                        <c:out value="${formatter.format(pro.price)}"/> vnđ
                                                                                    </span>
                                                                                        <span class="price">
                                                                                        <c:out value="${formatter.format(pro.price_sell)}"/> vnđ
                                                                                    </span>
                                                                                    </div>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            <div class="thumbnail-container border">
                                                                                <a href="product-detail.jsp">
                                                                                    <img class="img-fluid image-cover" src="${pro.listImg[0].url}" alt="img">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-9">
                                                                            <div class="product-description">
                                                                                <div class="product-groups">
                                                                                    <div class="product-title">
                                                                                        <a href="product-detail.jsp">${pro.name}</a>
                                                                                    </div>
                                                                                    <div class="rating">
                                                                                        <div class="star-content">
                                                                                            <div class="star"></div>
                                                                                    ...
                                                                                    <div class="product-group-price">
                                                                                        <c:if test="${pro.price_sell < pro.price}">
                                                                                            <div class="product-price-and-shipping">
                                                                                            <span class="price" style="font-size: 12px;text-decoration: line-through;color:#939393;">
                                                                                                ${formatter.format(pro.price)} vnđ
                                                                                            </span>
                                                                                                <span class="price">${formatter.format(pro.price_sell)} vnđ</span>
                                                                                            </div>
                                                                                        </c:if>
                                                                                        <c:if test="${pro.price_sell >= pro.price}">
                                                                                            <div class="product-price-and-shipping">
                                ...
                                <span class="price" style="font-size: 12px;text-decoration: line-through;color:#939393;padding-bottom: 8px;">
                                    ${formatter.format(pro.price)} vnđ
                                </span>
                                                                                        <span class="price">${formatter.format(pro.price_sell)} vnđ</span>
                                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-9">
                                                                            <div class="product-description">
                                                                                <div class="product-groups">
                                                                                    <div class="product-title">
                                                                                        <a href="product-detail.jsp">${pro.name}
                                                                                        </a>
                                        ...
                                        <!-- pagination -->
                                            ...
                                            <%--                                        <li class="page-item">--%>
                                            <%--                                            <a class="page-link"--%>
                                            <%--                                               href="search?${textSearch}&page=<%=pageNum- 1 %>&display=<%=display%>&orderBy=<%=orderBy%>&sortBy=<%=sortBy%>"--%>
                                            <%--                                               aria-label="Previous">--%>
                                            ...
                                            <%--                                            <a class="page-link"--%>
                                            <%--                                               href="search?${textSearch}&page=<%=i%>&display=<%=display%>&orderBy=<%=orderBy%>&sortBy=<%=sortBy%>">--%>
                                            <%--                                                <%=i%>--%>
                                            <%--                                            </a>--%>
                                            <%--                                        </li>--%>
                                            <%--                                        <%} else {%>--%>
                                        ...
                                        <div class="block-content" style="">
                                            <div class="policy-item">
                                                <div class="policy-content iconpolicy1">
                                                    <img src="<c:url value="/Template/web/img/home/policy-index-removebg.png"/>"
                                                         alt="img">
                                        ...
                                        <div class="block-content">
                                            <div class="policy-item">
                                                <div class="policy-content iconpolicy2">
                                                    <img src="<c:url value="/Template/web/img/home/1on1-removebg.png"/>"
                                                         alt="img">
                                                    <div class="description">
                                        ...
                                        <div class="block-content">
                                            <div class="policy-item">
                                                <div class="policy-content iconpolicy3" style="text-align: center">
                                                    <img src="<c:url value="/Template/web/img/home/warranty-removebg.png"/>"
                                                         alt="img">
                                                    <div class="description">
