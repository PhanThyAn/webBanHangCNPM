    ...
    <section class="content">
      <div class="error-page">
        ...
        <div class="error-content">
          <h3><i class="fas fa-exclamation-triangle text-danger"></i> Oops! Đã có lỗi xảy ra.</h3>

          <p>
            Chúng tôi sẽ sớm sửa chữa lại.
            trong lúc này bạn có thể <a href="../../index.html">trở lại trang chủ quản trị</a> hoặc sử dụng công cụ tìm kiếm bên dưới.
          </p>
