...
public class UserDAO {
    ...
    public static UserModel findLogin(String username, String password) throws Exception {
        UserModel user = null;
        ResultSet rs;
    ...
    public static void addUser(String user_name, String password, String full_name, String email, String gender) throws Exception {
        PreparedStatement pst;
        String sql;
        try {
    ...
    public static boolean checkUserName(String user_name) throws Exception{
    ...
    private static boolean check(String col, String value)  throws Exception{
        PreparedStatement pst;
        String sql;
        ResultSet rs;
        try {
    ...
    public static void updateUserAdmin(UserModel user)  throws Exception{
        PreparedStatement pst;
        String sql;
        try {
    ...
    public static void detele(int id)  throws Exception{
        PreparedStatement pst;
        String sql;
        try {
  ...
  /*  private static void deteleUserOrder(String username){
    ...
    public static void updateToken(int id, String token)  throws Exception{
        PreparedStatement pst;
        String sql;
        try {
    ...
    public static void addToken(int id, String token, Timestamp create_date, Timestamp token_expiry) throws Exception {
        PreparedStatement pst;
        String sql;
        try {
